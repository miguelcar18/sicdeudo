...
@section('titulo')
<title>Solicitudes de ayudantías técnicas - Sicdeudo</title>
@stop

@section('content')
@include('back.layouts.content-title', ['titulo' => 'Solicitudes de Ayudantías Técnicas'])
<div class="row">
	<div class="col-sm-12">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-primary waves-effect waves-light" href="{{ URL::route('estudioSE', [$solicitud->nombreEstudiante->id, 3]) }}"> <span>Estudio Socio-Económico</span> </a>
							@else
