<h4 class="header-title m-t-0">REQUISITOS A CONSIGNAR PARA PROGRAMA DE BECAS DE RESIDENCIA</h4>
<div class="p-20">
	<div class="form-group row">
		...
		<label for="requisitos" class="col-sm-12 form-control-label text-danger">Debe imprimir la planilla de solicitud de beca de residencia y entregarla con todos los requisitos en la coordinación del programa de becas de residencia.</label>
	</div>
	<div class="form-group row">
		<div class="col-sm-6">
			{!! Form::button('Enviar', ['class'=> 'btn btn-primary waves-effect waves-light pull-right', 'id' => 'solicitudBRSubmit', 'type' => 'submit', 'data' => 1]) !!}
		</div>
		<div class="col-sm-6">
