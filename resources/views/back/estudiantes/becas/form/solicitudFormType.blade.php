...
<div class="p-20">
	...
	<div class="form-group row">
		...
		<label for="fechaNacimiento" class="col-sm-2 form-control-label">Fecha de Nacimiento <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::text('fechaNacimiento', null, ['placeholder' => 'dd/mm/yyyy', 'class' => 'form-control', 'id' => 'fechaNacimiento', 'required' => true]) !!}
		</div>
	</div>
	<div class="form-group row">
		...
		<label for="lugarNacimiento" class="col-sm-2 form-control-label">Lugar de Nacimiento <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::text('lugarNacimiento', null, ['placeholder' => 'Lugar de nacimiento', 'class' => 'form-control', 'id' => 'lugarNacimiento', 'required' => true]) !!}
		</div>
	</div>
	<div class="form-group row">
...
<div class="p-20">
	...
	<div class="form-group row">
		...
		<label for="creditosSemestreAnterior" class="col-sm-2 form-control-label">Créditos Aprobados en el Semestre Anterior <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::input('number', 'creditosSemestreAnterior', null, ['id' => 'creditosSemestreAnterior', 'class' => 'form-control', 'placeholder' => 'Número de créditos', 'required' => true, 'min' => '0']) !!}
		</div>
	</div>
	<div class="form-group row">
		<label for="creditosAprobadosCarrera" class="col-sm-2 form-control-label">Total de Créditos Aprobados en la Carrera <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::input('number', 'creditosAprobadosCarrera', null, ['id' => 'creditosAprobadosCarrera', 'class' => 'form-control', 'placeholder' => 'Total de créditos aprobados', 'required' => true, 'min' => '0']) !!}
		</div>
	...
	<div class="form-group row">
		<label for="numeroCreditosInscritos" class="col-sm-2 form-control-label">Número de Créditos Inscritos Actualmente <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::input('number', 'numeroCreditosInscritos', null, ['id' => 'numeroCreditosInscritos', 'class' => 'form-control', 'placeholder' => 'Número de créditos inscritos', 'required' => true, 'min' => '0']) !!}
		</div>
		<label for="numeroMateriasInscritas" class="col-sm-2 form-control-label">Número de Materias Inscritas Actualmente <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::input('number', 'numeroMateriasInscritas', null, ['id' => 'numeroMateriasInscritas', 'class' => 'form-control', 'placeholder' => 'Número de materias inscritas', 'required' => true, 'min' => '0']) !!}
		</div>
	</div>
</div>
...
<div class="p-20">
	<div class="form-group row">
		<label for="observacionesResidencia" class="col-sm-2 form-control-label">Opinión y observaciones sobre las características de su residencia <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::textarea('observacionesResidencia', null, $attributes = array('id' => 'observacionesResidencia', 'class' => 'form-control', 'rows' => '3')) !!}
		</div>
	...
	<div class="form-group row">
		<label for="alquilaSolo" class="col-sm-2 form-control-label">¿La residencia es alquilada solo por usted? <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::select('alquilaSolo', array('' => 'Seleccione', '1' => 'Si', '0' => 'No'), null, $attributes = array('id' => 'alquilaSolo', 'class' => 'form-control', 'required' => 'required')) !!}
		</div>
	</div>
</div>