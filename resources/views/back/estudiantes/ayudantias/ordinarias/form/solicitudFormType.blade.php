...
<div class="p-20">
	<div class="form-group row">
		<label for="lugarCumplimiento" class="col-sm-4 form-control-label">¿En que lugar le gustaría cumplir su ayudantía? <span class="text-danger">*</span></label>
		<div class="col-sm-8">
			{!! Form::text('lugar', null, ['placeholder' => 'Lugar de cumplimiento', 'class' => 'form-control', 'id' => 'lugar', 'required' => true]) !!}
		</div>
	</div>
	<div class="form-group row">
		<label for="area" class="col-sm-2 form-control-label">Área de Habilidades, Destrezas y/o Capacitación <span class="text-danger">*</span></label>
		<div class="col-sm-4">
			{!! Form::textarea('habilidades', null, $attributes = array('id' => 'habilidades', 'class' => 'form-control', 'rows' => '3')) !!}
		</div>
