<h4 class="header-title m-t-0">REQUISITOS PARA INGRESAR AL PROGRAMA DE BECAS DE RESIDENCIA</h4>
<div class="p-20">
    ...
    <div class="form-group row" id="botones" style="display: none">
        ...
        <div class="col-sm-6">
            {!! Form::button('Regresar', ['class'=> 'btn btn-secondary waves-effect m-l-5', 'id' => 'cancelar', 'type' => 'button', 'onclick' => "document.location.href = '".URL::route('solicitudesBecasResidencia')."'"]) !!}
        </div>
    </div>
</div>