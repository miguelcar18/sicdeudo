...
<div class="p-20">
    ...
    <div class="form-group row" id="botones" style="display: none">
        ...
        <div class="col-sm-6">
            {!! Form::button('Regresar', ['class'=> 'btn btn-secondary waves-effect m-l-5', 'id' => 'cancelar', 'type' => 'button', 'onclick' => "document.location.href = '".URL::route('solicitudesAyudantiasTecnicas')."'"]) !!}
        </div>
    </div>
</div>