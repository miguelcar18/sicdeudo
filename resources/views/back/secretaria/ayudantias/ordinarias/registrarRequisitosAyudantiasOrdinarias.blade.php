		...
		<div class="card-box">
			<div class="row">
				<div class="col-sm-12 col-xs-12 col-md-12">
					{!! Form::open(['route' => 'registrarRequisitosAO', 'method' => 'post', 'id' => 'requisitosSolicitudAOForm', 'name' => 'requisitosSolicitudAOForm', 'class' => 'registrarRequisitos', 'novalidate' => 'novalidate', 'role' => 'form']) !!}
