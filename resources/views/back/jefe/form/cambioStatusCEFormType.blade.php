<div class="p-20">
	<div class="row">
        <div class="col-xs-12 col-sm-6">
            <div class="form-group clearfix">
                <label for="name"><b>Apellidos y nombres:</b> {{ $estudiante->name }} </label>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <div class="form-group clearfix">
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
			{!! Form::select('status', array('' => 'Seleccione', 'Revisado por secretaría' => 'Revisado por secretaría', 'Aprobado' => 'Aprobado', 'Rechazado' => 'Rechazado'), null, $attributes = array('id' => 'status', 'class' => 'required form-control')) !!}
		</div>
